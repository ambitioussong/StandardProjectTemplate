...
#define PASSWORD @"si-G$KF;*,k$N2/A,7r[0[{;"
...
static Byte ivBuff[]   = {0x7, 0x3, 0x3, 0x6, 0x5, 0xa, 0x2, 0xb, 0xc, 0x9, 0x2, 0x5, 0x7, 0xd, 0xe, 0x0};
...
{
    if (string == nil)
        [NSException raise:NSInvalidArgumentException format:@"InvalidArgument"];
    if ([string length] == 0)
        return [NSData data];
